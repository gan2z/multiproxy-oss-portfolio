...
※本ページに掲載している構成・スクリプト・ログ・画像は、個人のローカル検証環境におけるものです。  
...
<figure style="margin: 1.2em auto; text-align:center;">
  ...
  <figcaption style="margin-top:.6em; font-size:.92em; opacity:.85;">
    クリック/タップで原寸表示（別タブ）。
    <strong>コンテナ稼働・プロセス・疎通</strong>など、検証・監視で確認する観測点を例示します
  </figcaption>
</figure>
...
これは単なる構築自動化ではなく、  
**検証・再現・改善を前提とした設計力を示すための取り組み**です。
