...
### 4-2. プロキシ間通信を stunnel で TLS 化した理由
...
### 5-1. stunnel が「構造的に必須」であると理解するまで
...
### 5-3. 認証基盤（AD / LDAP / Kerberos）のブラックボックスを解消
